...
const sources = {
  ...
  stockRepository: [
    ...
    "src-tauri/src/db/stock_repository/export.rs",
  ...
  stocktakeRepository: [
    "src-tauri/src/db/stocktake_repository.rs",
    "src-tauri/src/db/stocktake_repository/confirmation.rs",
    "src-tauri/src/db/stocktake_repository/tests.rs",
  ],
  reportRepository: [
    "src-tauri/src/db/report_repository.rs",
    "src-tauri/src/db/report_repository/consumption.rs",
    "src-tauri/src/db/report_repository/tests.rs",
  ],
  ...
  masterDataRepository: [
    "src-tauri/src/db/master_data_repository.rs",
    "src-tauri/src/db/master_data_repository/items.rs",
    "src-tauri/src/db/master_data_repository/tests.rs",
  ],
  ...
  hostService: [
    ...
    "src-tauri/src/services/host_service/auth.rs",
    "src-tauri/src/services/host_service/client_registry.rs",
    "src-tauri/src/services/host_service/http_client.rs",
    ...
    "src-tauri/src/services/host_service/responses.rs",
    "src-tauri/src/services/host_service/routes/stock.rs",
  ...
  reportService: [
    ...
    "src-tauri/src/services/report_service/summary_sheets.rs",
    "src-tauri/src/services/report_service/detail_sheets.rs",
    "src-tauri/src/services/report_service/inventory_sheets.rs",
    "src-tauri/src/services/report_service/tests.rs",
  ],
  stockService: [
    "src-tauri/src/services/stock_service.rs",
    "src-tauri/src/services/stock_service/export.rs",
    "src-tauri/src/services/stock_service/tests.rs",
  ],
  masterDataService: [
    "src-tauri/src/services/master_data_service.rs",
    "src-tauri/src/services/master_data_service/items.rs",
    "src-tauri/src/services/master_data_service/tests.rs",
  ],
  httpTransport: "src-tauri/src/infrastructure/http_transport.rs",
  desktop: "src-tauri/src/desktop.rs",
  stocktakeService: "src-tauri/src/services/stocktake_service.rs",
  statusService: [
    "src-tauri/src/services/status_service.rs",
    "src-tauri/src/services/status_service/settings.rs",
    "src-tauri/src/services/status_service/settings_helpers.rs",
    "src-tauri/src/services/status_service/tests.rs",
  ],
  userService: [
    "src-tauri/src/services/user_service.rs",
    "src-tauri/src/services/user_service/account_operations.rs",
    "src-tauri/src/services/user_service/password_reset_mail.rs",
    "src-tauri/src/services/user_service/tests.rs",
  ],
  migrationsService: [
    "src-tauri/src/db/migrations.rs",
    "src-tauri/src/db/migrations/tests.rs",
    "src-tauri/src/db/performance_migrations.rs",
  ],
...
const requirements = [
  ...
  },
  {
    ...
    checks: [
      ...
      ["物品档案前端包含供应商下拉筛选", "app", "全部供应商"],
      ["物品列表供应商查询有数据库测试", "masterDataRepository", "list_items_filters_by_supplier_without_affecting_unfiltered_results"],
      ["物品档案导出复用供应商筛选", "masterDataService", "export_items_applies_supplier_filter"],
      ["远程物品列表透传供应商筛选", "hostService", "remote_item_list_applies_supplier_filter"],
  ...
  },
  {
    ...
    checks: [
      ...
      ["库存台账包含管理员全量导出入口", "app", "导出全部库存"],
      ["Tauri 注册库存台账全量导出", "lib", "export_stock_balances"],
      ["库存导出快照覆盖零库存负库存和停用物品", "stockRepository", "stock_balance_export_snapshot_includes_all_item_states_and_details"],
      ["库存全量导出要求管理员权限", "stockService", "export_stock_balances_requires_admin_role"],
      ["库存全量导出工作簿和审计有测试覆盖", "stockService", "export_stock_balances_writes_complete_workbook_and_audit"],
      ["远程库存导出拒绝非管理员", "hostService", "remote_inventory_export_rejects_non_admin_user"],
      ["远程库存导出记录实际管理员", "hostService", "remote_inventory_export_returns_xlsx_and_audits_actual_admin"],
      ["库存导出二进制传输有往返测试", "httpTransport", "xlsx_response_round_trip_preserves_binary_body_and_row_count"],
  ...
  },
  {
    ...
    checks: [
      ...
      ["Tauri 启用 Windows 系统托盘能力", "cargoToml", "\"tray-icon\""],
      ["Windows 托盘包含显示与退出菜单", "desktop", "TrayIconBuilder"],
      ["Windows 仅拦截主窗口关闭", "desktop", "only_main_window_is_hidden_on_close"],
      ["Windows 托盘退出使用应用级退出", "desktop", "app.exit(0)"],
      ...
      ["GitHub CI 执行结构化覆盖校验", "githubCi", "npm run verify:execution-map"],
      ["GitHub CI 执行前端代码覆盖率", "githubCi", "npm run test:coverage"],
