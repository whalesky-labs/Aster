...
import { PaginatedTable, Status, TableFeatureToolbar, TableSearchToolbar } from "../../shared/ui/DataTable";
...
export function ItemsPage({ canImportItems, canWrite, categories, formatMoney, itemSearch, items, onCreate, onEdit, onExportItems, onImportItems, onSearch, onToggle, suppliers, units }: {
  ...
  return <section className="table-panel">
    ...
    <TableSearchToolbar onSearchChange={setSearch} onSubmit={onSearch} placeholder="搜索编码、名称、规格" search={search} searchLabel="关键字" />
